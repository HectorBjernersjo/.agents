...
Start by running git status. If there are any uncommitted changes, tell the user to commit them before you proceed, so `git diff origin/master...` works properly.
